...
(function($) {
    $.jQTouch = function(options) {
        ...
        function doNavigation(fromPage, toPage, animation, goingBack) {
            ...
            fromPage.trigger('pageAnimationStart', { direction: 'out' , reverse: goingBack});//SAM MODIFIED
            toPage.trigger('pageAnimationStart', { direction: 'in', fromId : fromPage[0].id , reverse: goingBack });//SAM MODIFIED
            ...
            function navigationEndHandler(event) {
                ...
                toPage.trigger('pageAnimationEnd', {direction:'in', animation:animation, fromId : fromPage[0].id , reverse: goingBack});//SAM MODIFIED
                fromPage.trigger('pageAnimationEnd', {direction:'out', animation:animation, reverse: goingBack});//SAM MODIFIED
        ...
        function goBack(numberOfPages) {//SAM : ajout du param numberOfPage
            _debug();
			
			if (numberOfPages) {//SAM : ajout pour gérer le number of page
				// Remove all pages in front of the target page 
                hist.splice(1, numberOfPages-1);//doesnt work :-(
